...
import 'home_coach_model.dart';
export 'home_coach_model.dart';

class HomeCoachWidget extends StatefulWidget {
  const HomeCoachWidget({super.key});

  @override
  State<HomeCoachWidget> createState() => _HomeCoachWidgetState();
}

class _HomeCoachWidgetState extends State<HomeCoachWidget> {
  late HomeCoachModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeCoachModel());
  }
