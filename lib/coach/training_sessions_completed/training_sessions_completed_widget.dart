...
import 'training_sessions_completed_model.dart';
export 'training_sessions_completed_model.dart';

class TrainingSessionsCompletedWidget extends StatefulWidget {
  const TrainingSessionsCompletedWidget({super.key});

  @override
  State<TrainingSessionsCompletedWidget> createState() =>
      _TrainingSessionsCompletedWidgetState();
}

class _TrainingSessionsCompletedWidgetState
    extends State<TrainingSessionsCompletedWidget> {
  late TrainingSessionsCompletedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrainingSessionsCompletedModel());
  }
