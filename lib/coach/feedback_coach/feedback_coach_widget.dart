import '/component/ratings/ratings_widget.dart';
import '/component/videos/videos_widget.dart';
...
import 'feedback_coach_model.dart';
export 'feedback_coach_model.dart';

class FeedbackCoachWidget extends StatefulWidget {
  const FeedbackCoachWidget({super.key});

  @override
  State<FeedbackCoachWidget> createState() => _FeedbackCoachWidgetState();
}

class _FeedbackCoachWidgetState extends State<FeedbackCoachWidget> {
  late FeedbackCoachModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FeedbackCoachModel());
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      'The standard reflection questions will be used, or you can edit the standard questions.',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Poppins',
