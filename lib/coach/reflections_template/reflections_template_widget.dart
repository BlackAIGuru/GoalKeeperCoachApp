...
class ReflectionsTemplateWidget extends StatefulWidget {
  const ReflectionsTemplateWidget({super.key});

  @override
  State<ReflectionsTemplateWidget> createState() =>
      _ReflectionsTemplateWidgetState();
}

class _ReflectionsTemplateWidgetState extends State<ReflectionsTemplateWidget> {
  late ReflectionsTemplateModel _model;
