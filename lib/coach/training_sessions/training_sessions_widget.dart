...
import 'training_sessions_model.dart';
export 'training_sessions_model.dart';

class TrainingSessionsWidget extends StatefulWidget {
  const TrainingSessionsWidget({super.key});

  @override
  State<TrainingSessionsWidget> createState() => _TrainingSessionsWidgetState();
}

class _TrainingSessionsWidgetState extends State<TrainingSessionsWidget> {
  late TrainingSessionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrainingSessionsModel());
  }
